<?php
$thumbBase = "http://www.phillipuniverse.com/three20-photo-gallery/sports/thumbs/";
$imageBase = "http://www.phillipuniverse.com/three20-photo-gallery/sports/" . basename(dirname(__FILE__));
$handle = opendir('.');
$photos = array();
while(false !== ($file = readdir($handle))) {
	...
	if($extension == 'jpg') {
		...
		list($thumbWidth, $thumbHeight, $thumbType, $thumbAttr) = getimagesize("../thumbs/thumb_$file");
		$photo['thumb'] = array();
		$photo['thumb']['width'] = $thumbWidth;
		$photo['thumb']['height'] = $thumbHeight;
		$photo['thumb']['url'] = $thumbBase . "thumb_" . $file;
